...
\cventry{2025 - Presente}{Desarrollador Mobile Front-End}{Faro}{}{}{
    \begin{itemize}
        \item Desarrollo de la aplicacion multiplataforma utilizando Flutter y manejo de estado con Riverpod.
        \item Unit Testing. Aplicación de la metodología Test Driven Development.
        \item Utilización de golden tests para preservar el diseño de la UI realizado en Figma.
    \end{itemize}y
    \textbf{App Store:} \href{https://apps.apple.com/ar/app/faro-conecta/id6751785959}{https://apps.apple.com/ar/app/faro-conecta/id6751785959}
}
...
\cventry{2023 - 2024}{Hacking Ético y Ciberseguridad}{HackerOne}{}{}{
...
\cvitem{Experiencia básica}{C\#, Dart, Flutter, Riverpod, Java, TypeScript, Python, Unity, ReactJS, C++, MySQL, AWS y Git.}
